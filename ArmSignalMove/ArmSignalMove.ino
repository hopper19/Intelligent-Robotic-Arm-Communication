...
// Defined movements
int Move [NumbMotions][MotionMovements][NumOfMotors][2]={{{{0,5},{25,1},{0,5},{0,1}},{{0,5},{25,1},{0,5},{0,1}},{{0,5},{25,1},{0,5},{0,1}},{{50,5},{25,1},{0,5},{50,1}}},
                                               {{{20,5},{10,1},{10,5},{10,1}},{{2,5},{50,1},{50,5},{10,1}},{{35,5},{0,1},{25,5},{10,1}},{{20,5},{20,1},{10,5},{10,1}}}};

// Servo Motor Definitions   {starting angle, minimum angle, maximum angle, minimum delay increment in STP}
int SM[NumOfMotors][NumOfParam]={{120,120,70,10},{80,80,120,10},{30,30,180,10},{120,30,122,10}};
